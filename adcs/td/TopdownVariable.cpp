...
namespace Adcs { namespace Td {
    Variable::Variable(ad::rt::td::variable<double>&& native)
        : _native(new ad::rt::td::variable<double>(std::move(native)))
    {}

    const ad::rt::td::variable<double>& Variable::get_native()
    {
        return *_native;
    }

    Variable::Variable(Variable ^ other)
        : _native(new ad::rt::td::variable<double>(*other->_native))
    {
    }
